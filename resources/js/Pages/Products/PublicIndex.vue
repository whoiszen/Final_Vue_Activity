        ...
        <div class="max-w-7xl mx-auto px-4 py-12">
            ...
            <div v-else-if="error" class="text-center py-20">
                ...
                <button
                    ...
                    class="mt-4 px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition"
                >
                    Try Again
                </button>
            </div>
            ...
            <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                >
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-indigo-700 font-bold text-lg">PHP {{ Number(product.price).toLocaleString() }}</span>
...
async function fetchProducts(page = 1) {
    ...
    try {
        ...
        error.value = 'We could not load products right now.';
        console.error(err);
    } finally {
        loading.value = false;
    }
